...
## Project Structure
    ...
    ├── testapiautosetting_125099  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125099`
...
2. Clone this repo and `cd testapiautosetting_125099`
